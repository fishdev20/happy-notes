...
const AppMenu = () => {
  return (
    <header
      className="flex h-[4rem] shrink-0 items-center gap-2 border-b px-4 justify-between bg-gray-50"
    ...
    >
      <div className="flex gap-2" style={{ WebkitAppRegion: "no-drag" }}>
        <img
          ...
          height={30}
        />
        <h1 className="font-extrabold font-stretch-50%" style={{ WebkitAppRegion: "no-drag" }}>
          Happy notes
        </h1>
      </div>
